module.exports = app => {
    const { existisOrError, notExistOrError } = app.api.validation
    ...
    const save = async(req, res) => {
        ...
        try{
            ...
            existisOrError(existisContainer, "O Container informado não existe!")
    ...
    const remove = async (req, res) => {
        try{
            ...
            const rowsDeleted = await app.db('movimentacoes').where({id: req.params.id}).del()
